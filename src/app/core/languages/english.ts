export const ENGLISH_LANGUAGE_CONSTANTS = {
  landingPageSubHeader: 'Fast, Efficient and Productive',
  ...
  enterCredentialMessage: 'Enter your credential to access your account.',
  ...
  errorEmail: 'Email must be an email address valid',
  ...
  mobileSignInMsg: 'Enter the valid mobile number to proceed',
  setupNewPassword: 'Setup New Password',
  setupNewPasswordSubheader: 'Have you already reset the password ?',
  signInWithMobileNo: 'Sign in using mobile number',
  getOtp: 'Get OTP',
